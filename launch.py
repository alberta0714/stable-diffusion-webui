...
def prepare_environment():
    ...
    torch_command = os.environ.get('TORCH_COMMAND', "pip install torch==1.13.1+cu117 torchvision==0.14.1+cu117  --no-cache-dir --extra-index-url https://download.pytorch.org/whl/cu117")
